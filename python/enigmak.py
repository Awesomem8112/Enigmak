#!/usr/bin/env python3
"""
ENIGMAK v3.0.0-rc.5 - Command-line cipher machine
...
def cmd_interactive():
    print('ENIGMAK v3.0.0-rc.5 Interactive Mode')
    print('======================================')
...
def main(argv=None):
    ...
    parser = FriendlyArgumentParser(
        description='ENIGMAK v3.0.0-rc.5 - 95-symbol rotor cipher',
